...
6. Open the public card and confirm it shows only the safe public development summary and verified domain—not raw inputs, private rules, or owner identity.
7. Select Owner B and confirm Atlas remains inaccessible privately.

Do not reset production. Park, Reactivate, Transfer, and Continue are not implemented.
